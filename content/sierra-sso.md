---
title: "Sierra Staff and Single Sign-On"
template: session
day: wednesday
date: "April 15"
description: "Session recap from IUG 2026: implementing SAML SSO for Sierra staff and patron authentication, MFA practices, shared accounts, identity providers, and Keycloak as a potential unified identity layer."
speakers:
  - justin-newcomer
speakers_display: "Justin Newcomer (Rochester Institute of Technology) &middot; 3:00&ndash;4:00 PM &middot; Cook &middot; Gatherings (Sierra)"
---
...
<div class="section-list">
  ...
  <div class="section-item">
    ...
    <p>Attendees noted that <strong>any shared account</strong> can move a library into a more expensive cyber-insurance tier, even if the account&rsquo;s permissions are heavily restricted. The cheapest rate typically requires every user to be a single signer with no shared service accounts &mdash; which has pushed some libraries to phase out shared accounts for programs and provision per-person accounts instead.</p>
  </div>
</div>
